...
class TestModel(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        data_original = pd.read_csv("F:/Users/Documents/Program Class/latam2/data/data.csv")

        # Asegurar que el CSV esté creado
        self.model.ensure_csv_exists(data_original, target_column="delay")

        # Leer el archivo CSV ya creado
        self.data = pd.read_csv(filepath_or_buffer="F:/Users/Documents/Program Class/latam2/data/data_procesado.csv")
